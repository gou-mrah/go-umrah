...
const TermsAndConditionsPage = ({ t, currentLang }) => {
  const pageData = t.termsAndConditionsPage || {};
  const pageTitle = pageData.title || 'Terms and Conditions';
  const pageDescription = pageData.description || '';
  const content = pageData.content || [];

  return (
    <GenericPage pageKey="termsAndConditions" pageTitle={pageTitle} pageDescription={pageDescription} t={t} currentLang={currentLang}>
